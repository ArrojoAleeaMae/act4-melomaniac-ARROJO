...
body {
    background: url(images/dust.gif);
    ...
    background-repeat: no-repeat;
        ...
        <header class="bg-light bg-gradient text-primary">
            <div class="container px-4 text-center">
                <div class="profile mr-3"><img src="images/disney-background.png" width="400"> 
                <h1 class="fw-bolder">Welcome to DisneyLand Melody</h1>
                <p class="lead">Melodies that pulls you back to those enchanting & wonderful moments</p>
